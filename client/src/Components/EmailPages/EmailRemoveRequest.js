    ...
    render() {
        ...
        return (
            <div>
                ...
                {
                     <InfoPage description={emailRemoved?"Uspesno uklonjen zahtev iz sistema usled neispravnih podataka, pokusajte ponovo... ": "Uklanjanje u toku..." }/>               
                }
            </div>
        );
    }
...
const mapDispatchToProps = (dispatch) => {
    ...
    return {
        removeRequestEmail: (id) => {  dispatch(RemoveRequestEmail(id)) }
    }
}
