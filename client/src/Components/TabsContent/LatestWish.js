...
import {GetLatestWish, PrepareRequest} from '../../Actions/NavActions/LatestWishActions';
...
class LatestWish extends Component {
    ...
    render() {
        ...
        return (
            ...
            this.props.latestWish!==null?(<div id="tab-2" className="tab-content current">
...
const mapDispatchToProps = (dispatch) => {
    ...
    return {
        getLatestWish: () => {  dispatch(GetLatestWish()) },
